...
void DataStore::loadPrefsInt(const char *filename, NodePrefs& _prefs, double& node_lat, double& node_lon) {
  ...
  if (file) {
    ...
    file.read((uint8_t *)&_prefs.vibration_quiet, sizeof(_prefs.vibration_quiet));         // 88
    file.close();
  }
}
...
void DataStore::savePrefs(const NodePrefs& _prefs, double node_lat, double node_lon) {
  ...
  if (file) {
    ...
    file.write((uint8_t *)&_prefs.vibration_quiet, sizeof(_prefs.vibration_quiet));         // 88 (added last)
