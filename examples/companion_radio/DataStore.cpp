...
void DataStore::loadPrefsInt(const char *filename, NodePrefs& _prefs, double& node_lat, double& node_lon) {
  ...
  if (file) {
    ...
    file.read((uint8_t *)&_prefs.vibration_quiet, sizeof(_prefs.vibration_quiet));         // 85
    ...
    file.read((uint8_t *)&_prefs.autoadd_config, sizeof(_prefs.autoadd_config));           // 88
...
void DataStore::savePrefs(const NodePrefs& _prefs, double node_lat, double node_lon) {
  ...
  if (file) {
    ...
    file.write((uint8_t *)&_prefs.vibration_quiet, sizeof(_prefs.vibration_quiet));         // 85
    ...
    file.write((uint8_t *)&_prefs.autoadd_config, sizeof(_prefs.autoadd_config));           // 88
